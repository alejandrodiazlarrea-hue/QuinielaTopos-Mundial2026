...
export const BadgesScreen = ({ participants, earnedBadges }) => {
  ...
  const howTo = {
    ...
    SO_HOT:       "Si aciertas entre 2 y 3 resultados correctos en la jornada.",
    ON_FIRE:      "Si aciertas entre 4 y 6 resultados correctos en la jornada.",
    MODO_BESTIA:  "Si aciertas entre 7 y 9 resultados correctos en la jornada.",
    EN_SU_PRIME:  "Si aciertas 10 o más resultados correctos en la jornada.",
