...
export const BADGE_DEFS = {
  ...
  MODO_BESTIA:  { emoji:"🐺", name:"En su Prime",    desc:"16+ resultados correctos en una jornada",     coins:120,  type:"season" },
  EN_SU_PRIME:  { emoji:"🌟", name:"Dios Plan",    desc:"Jornada perfecta — todos los resultados",     coins:250,  type:"season" },
  GGS:          { emoji:"🧊", name:"Hacker",            desc:"Acertó el partido con menor % de aciertos",   coins:60,   type:"season" },
  MIL_IQ:       { emoji:"🧠", name:"+1000 de IQ",        desc:"Único en acertar un resultado",               coins:100,  type:"season" },
  ...
  F_WE:         { emoji:"💀", name:"F we",           desc:"Cero puntos en la jornada",                   coins:-50,  type:"dynamic" },
};
